...
- (void)createLeftBtn{
    ...
    //创建 全局统一 按钮
    UIBarButtonItem * item = [UIBarButtonItem itemWithImage:[UIImage imageNamed:@"navigation_back"] highImage:[UIImage imageNamed:@"navigation_back"]  target:self action:@selector(navbanckBtnClick)];
