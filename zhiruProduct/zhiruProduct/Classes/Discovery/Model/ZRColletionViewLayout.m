...
static const UIEdgeInsets Insets = {15, 15, 15, 15};
/** 默认的列数 */
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGFloat h;
    if (indexPath.item == 0) {
        h = 120*667/SCREEN_HEIGHT;
    }else{
        h = 240*667/SCREEN_HEIGHT;
    }
...
//        //设置item的位置
//        if (i==0) {
//            attris.frame = CGRectMake(0,0,165*375/SCREEN_WIDTH,120*667/SCREEN_HEIGHT);
//        }else{
