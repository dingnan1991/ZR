...
{
    UIImage *backImage = ZRImage(@"tu-0");
    [self drawImage:backImage Rect:CGRectMake(15, 7.5, SCREEN_WIDTH-30, self.height-15)];
    
    //title
#warning 给了切图后再改成白色
    [self drawWithStr:self.titleStr Font:[UIFont systemFontOfSize:20] Color:[UIColor redColor] Point:CGPointMake(150, 20)];
    
    //查看全部
    [self drawWithStr:@"查看全部" Font:[UIFont systemFontOfSize:15] Color:[UIColor redColor] Point:CGPointMake(160, 60)];
