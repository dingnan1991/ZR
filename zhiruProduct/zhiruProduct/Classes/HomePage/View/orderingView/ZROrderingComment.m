...
- (void)createBottomBtn{
    ...
    CGFloat btnW =( self.width - 2 * spacing - 2 * btnSpacing ) * 0.33;
    CGFloat btnH = 30;
    CGFloat btnY = 10;
    for (int i = 0; i < 4; i++) {
        ...
        UIButton * bottomBtn = [MyControl createButtonWithFrame:CGRectMake(15 + i * btnW + i * btnSpacing, btnY, btnW, btnH) ImageName:nil Target:self Action:@selector(bottomBtnClick:) Title:@"全部 (210)"];
