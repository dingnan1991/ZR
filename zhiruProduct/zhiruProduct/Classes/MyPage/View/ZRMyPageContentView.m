...
- (void)createContentView
{
    ...
    [self.img setImage:[UIImage imageNamed:@"youhui"]];
    [self.contentLabel setText:@"我的钱包"];
    [self.contentLabel setTextAlignment:NSTextAlignmentCenter];
    [self.contentLabel setFont:[UIFont systemFontOfSize:15.0]];
...
- (void)setViewMasonary
{
    ...
    [self.contentLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(weakSelf.img.mas_bottom).with.offset(0);
