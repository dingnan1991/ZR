...
//    [self.stateButton setBackgroundColor:[UIColor yellowColor]];
    ...
    [self.stateButton setImage:[UIImage imageNamed:@"jiantoushang"] forState:UIControlStateNormal];
    [self.stateButton setImage:[UIImage imageNamed:@"jiantouxia"] forState:UIControlStateSelected];
...
//    [self.label setBackgroundColor:[UIColor whiteColor]];
    ...
    [self.agreementButton setTitleColor:RGBCOLOR(83, 83, 245) forState:UIControlStateNormal];
