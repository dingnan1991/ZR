...
- (void)createView
{
    ...
    [_manButton setImage:[UIImage imageNamed:@"jiantoushang"] forState:UIControlStateNormal];
    [_manButton setImage:[UIImage imageNamed:@"jiantouxia"] forState:UIControlStateSelected];
    ...
    [_womanButton setImage:[UIImage imageNamed:@"jiantoushang"] forState:UIControlStateNormal];
    [_womanButton setImage:[UIImage imageNamed:@"jiantouxia"] forState:UIControlStateSelected];
